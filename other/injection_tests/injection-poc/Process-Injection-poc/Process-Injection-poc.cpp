// Process-Injection-poc.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void inject(LPSTR name) {
  ...
  /*  printf("shellcode size: %d\n", sizeof(payload));
    DWORD flOldProtect;
    VirtualProtect(payload, sizeof(payload), PAGE_EXECUTE_READWRITE, &flOldProtect);
    (*(void (*)()) & payload)();*/
...
{
    //MessageBoxA(NULL, "Injector", "Injector running!", MB_OK);
    if (argc != 2) {
